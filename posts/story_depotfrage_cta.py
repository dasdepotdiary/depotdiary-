"""Call-to-Action-Story "Depot-Frage" (2026-09-16): fragt Follower direkt,
wie viele Aktien sie aktuell im Depot haben, und bittet per DM um ihr Depot
(Struktur, keine Aktiennamen/Betraege noetig) -- speist wie
story_depotranking_cta.py die spaetere ECHTE Depot-Ranking-Ausgabe.
Gleiche dunkle Optik wie format_depotranking.py.

Aufruf:
  python posts/story_depotfrage_cta.py
"""
import sys
...
def main():
    ...
    for line in ["WIE VIELE AKTIEN", "HABT IHR GERADE", "IM DEPOT?"]:
    ...
    body = "Schickt mir euer Depot -- nur die Struktur zaehlt: wie viele Positionen, wie viel Prozent in Aktien, ETFs, Krypto, Cash. Keine Aktiennamen oder echten Betraege noetig."
